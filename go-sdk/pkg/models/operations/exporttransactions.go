...
// ExportTransactionsRequestBodyFilters - Filter to narrow down events in export
type ExportTransactionsRequestBodyFilters struct {
...
type ExportTransactionsRequestBody struct {
	...
	Filters *ExportTransactionsRequestBodyFilters `json:"filters,omitempty"`
}

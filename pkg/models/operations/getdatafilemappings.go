...
type GetDatafileMappingsRequestBody struct {
	// offset for pagination
	Offset *int64 `json:"offset,omitempty"`
}

type GetDatafileMappingsRequest struct {
	RequestBody *GetDatafileMappingsRequestBody `request:"mediaType=application/json"`
...
type GetDatafileMappingsResponse struct {
	ContentType string
	StatusCode  int
